...
prebuild-staging:
	...
	sh $(DEPLOYMENTDIR)/prebuild-styling.sh
...
webapp-deploy-staging:
	@echo "Deploying to live.songpark.com"
	sh $(DEPLOYMENTDIR)/webapp.prep.sh
...
deploy-staging: prebuild-staging webapp-deploy-staging
