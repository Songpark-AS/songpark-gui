...
* [`src/web_app/`](src/web_app/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/web_app/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `web-app` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/web_app/config.cljs) defaults to `true` in
